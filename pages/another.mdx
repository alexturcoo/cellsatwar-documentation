...
The McMaster + GBC team is currently developing a physical learning pod to host an immersive cell-based gaming experience for students of all ages. 
Set in a stylized beta-cell, the learning pod experience will consist of 5 distinct, yet interconnected, 
mini-games designed to teach players more about the function of different organelles in a cell through the lens of insulin protein production. 
To be successful, players will need to work together to produce enough insulin to offset blood sugar 
spikes in a healthy body following various types of food intake.
